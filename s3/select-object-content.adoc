...
summary: Sie können die S3 SelectObjectContent-Anforderung verwenden, um den Inhalt eines S3-Objekts basierend auf einer einfachen SQL-Anweisung zu filtern. 
---
= SelectObjectContent
:allow-uri-read: 
:icons: font
...
Weitere Informationen finden Sie unter https://docs.aws.amazon.com/AmazonS3/latest/API/API_SelectObjectContent.html["Amazon Simple Storage Service API-Referenz: SelectObjectContent"^] .
