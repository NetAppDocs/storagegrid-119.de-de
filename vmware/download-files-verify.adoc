...
.Bevor Sie beginnen
Du hastlink:../vmware/downloading-and-extracting-storagegrid-installation-files.html#vmware-download-verification-package["das Verifizierungspaket heruntergeladen"] aus dem https://mysupport.netapp.com/site/products/all/details/storagegrid/downloads-tab["NetApp -Downloadseite für StorageGRID"^] .
...
. link:../vmware/downloading-and-extracting-storagegrid-installation-files.html["Führen Sie die restlichen Schritte aus"]um die entsprechenden Installationsdateien zu extrahieren und auszuwählen.
